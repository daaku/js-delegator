...
test('single rule single class', function() {
...
test('single rule two classes', function() {
...
test('single rule complext tag', function() {
...
test('two rules complext tag', function() {
